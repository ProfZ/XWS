...
public class CentralnaBankaService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/xws/XWS/XWS-SOAP/WEB-INF/wsdl/CentralnaBanka.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CentralnaBankaService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/xws/XWS/XWS-SOAP/WEB-INF/wsdl/CentralnaBanka.wsdl");
        }
        WSDL_LOCATION = url;
    }
