...
public interface RestServerRemote { 
	...
	public Response slanjeFakture(String id_dobavljaca, String sem, Faktura faktura) throws IOException, JAXBException;
	public Response obrisiStavku(String id_dobavljaca, long id_fakture, long redni_broj);
	public Response izmeniStavke(String id_dobavljaca, String sem, long id_fakture,
			long redni_broj, StavkaFakture newInvoiceItem);
	public Response pribaviStavku(String id_dobavljaca, long id_fakture,
			long redni_broj);
	Response novaStavka(String id_dobavljaca, String sem, long id_fakture,
